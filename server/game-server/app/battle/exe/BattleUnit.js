import { FightObj } from "./FightObj.js";
import { BUtils } from "./BUtils.js";
import { ActionType, AttrType, BufStatusType, BufTriggleType, SpecAttackType } from "./define/BDataComm.js";
import { BufMgr } from "./BufMgr.js";
import { UnitInfo } from "./define/UnitInfo.js";
import { SkillObj } from "./SkillObj.js";
//战斗单元
export class BattleUnit {
    ...
    doingAttack() {
        ...
        if (this.isCanAttack() == false)
            return;
        //判断闪避
        if (BUtils.hitRate(this.targetUnit.getAttr(AttrType.DodgeRate) - this.getAttrInPer(AttrType.RsDodgeRate))) {
            dmg = 0;
