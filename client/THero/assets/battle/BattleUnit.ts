...
export class BattleUnit{
    ...
    public attrVals:Map<AttrType,number> =new Map(); //额外属性的具体数值
    ...
    public constructor(troop:BattleTroop,unitInfo:Object,idx:number){
        this.troop = troop;
        ...
        this.info = unitInfo;
        this.unitCfg = BDataCfg.ins.getPetCfg(unitInfo["id"]);
    ...
    public setUnitInfo(unitInfo:Object){

        this.attrVals[AttrType.Attack] = unitInfo["attack"];
        this.attrVals[AttrType.AttackS] = unitInfo["attackS"];
        this.attrVals[AttrType.Defense] = unitInfo["defense"];
        this.attrVals[AttrType.DefenseS] = unitInfo["defenseS"];
        this.attrVals[AttrType.Speed] = unitInfo["speed"];

        this.attrVals[AttrType.Threat] = unitInfo["threat"];
        this.attrVals[AttrType.HP] = unitInfo["HP"];
        this.attrVals[AttrType.LuckRate] = unitInfo["luckRate"];
        
        this.attrVals[AttrType.TrumpRate] = unitInfo["trumpRate"];
        this.attrVals[AttrType.DodgeRate] = unitInfo["dodgeRate"];
        ...
        this.attrVals[AttrType.RsTrumpRate] = unitInfo["rsTrumpRate"];
        this.attrVals[AttrType.RsDodgeRate] = unitInfo["rsDodgeRate"];
        this.attrVals[AttrType.RsComboRate] = unitInfo["rsComboRate"];
        this.attrVals[AttrType.RsCounterRate] = unitInfo["rsCounterRate"];
        this.attrVals[AttrType.RsBloodRate] = unitInfo["rsBloodRate"];
        this.attrVals[AttrType.RsStunRate] = unitInfo["rsStunRate"];

        this.attrVals[AttrType.TrumpDmgRate] = unitInfo["trumpDmgRate"];
        this.attrVals[AttrType.RsTrumpDmgRate] = unitInfo["rsTrumpDmgRate"];
        
        this.attrVals[AttrType.CureRate] = unitInfo["cureRate"];
        
        this.attrVals[AttrType.DmgExtRate] = unitInfo["dmgExtRate"];
        this.attrVals[AttrType.RsDmgExtRate] = unitInfo["rsDmgExtRate"];
        this.attrVals[AttrType.CurHP] = unitInfo["curHP"];

        //如果curHP没赋值就赋值
        if(this.attrVals[AttrType.CurHP]==null){
