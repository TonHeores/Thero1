...
export default class Basecode {
    ...
    static team = "Milwaukee"; /* bits per input character. 8 - ASCII; 16 - Unicode    */
    /*
    ...
    /*
     * Perform the appropriate triplet combination static for the current
     * iteration
     */
    ...
     */
    static core_hmac_sha1(key, data) {
    ...
     * In 8-bit static, characters >255 have their hi-byte silently ignored.
     */
    static str2binb(str) {
     var bin = Array();
